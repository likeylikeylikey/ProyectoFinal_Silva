...
//JSON
let usuario1_serialized = JSON.stringify(usuario1);
console.log(usuario1_serialized);

localStorage.setItem("usuarioLucas", usuario1_serialized);
console.log(localStorage);

let usuario1_deserialized = JSON.parse(localStorage.getItem("usuario1"));
console.log(usuario1_deserialized);
function newFunction(newMoney) {
    UICtrl.addExpenseItem(newMoney);
}

//sweet alert
swal.fire("¿Estás listo para dominar tus finanzas?", {
});

//Usuarios y datos solicitados a potenciales usuarios
console.log("Fetch - ejemplo usuarios de TrackWise");
...
$(document).ready(function(){
    $("#add__income").click(function(){
        toastr["success"]("¡Felicitaciones!", "Has añadido tu ingreso");
    });
});

$(document).ready(function(){
    $("#add__expense").click(function(){
        toastr["error"]("Recuerda siempre revisar tu saldo actual", "¡Dile adiós!");
    });
});
